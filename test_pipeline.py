...
Does NOT require Ollama or local GPU — just sentence-transformers + chromadb.
"""
import sys, os, json
...
print("  (Set HF_API_TOKEN env var for LLM features: https://huggingface.co/settings/tokens)")
